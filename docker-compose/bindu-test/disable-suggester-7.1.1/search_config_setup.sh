...
# BINDU - Turn the suggester off in the core templates that will be used to produce the alfresco and archive cores
sed -i "s/solr\.suggester\.enabled=true/solr\.suggester\.enabled=false/g" $SOLR_RERANK_CORE_FILE $SOLR_NORERANK_CORE_FILE
